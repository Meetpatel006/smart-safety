    ...
    <ScrollView keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" contentContainerStyle={{ flexGrow: 1, justifyContent: "center", padding: 16 }}>
      ...
      >
        <Card>
          ...
          <Card.Content>
            <TextInput label={t(lang, "name")} value={name} onChangeText={setName} style={{ marginBottom: 8 }} autoCorrect={false} autoComplete="off" />
            <TextInput
              label={t(lang, "email")}
              value={email}
            ...
            <TextInput
              ...
              style={{ marginBottom: 8 }}
            />
            <TextInput label="Gov ID" value={govId} onChangeText={setGovId} style={{ marginBottom: 8 }} autoCorrect={false} autoComplete="off" />
            <TextInput label="Phone" value={phone} onChangeText={setPhone} style={{ marginBottom: 8 }} autoCorrect={false} autoComplete="off" />
            <TextInput
